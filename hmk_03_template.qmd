...
```
**Question 1:** r x
 ^It stopped working when I tried to do it
...
print(numbers)
```
**Question 1:** r numbers
I used the sample function to create a list of 10 random numbers between 1 and 10 that do not repeat.
